    ...
    <nav class="flex items-center justify-between" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">RealRealty</span>
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <a v-for="item in navigation" :key="item.name" :href="item.href"
           class="text-base leading-6 text-gray-500 hover:text-gray-900">{{ item.name }}</a>
      </div>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Log in</a>
      </div>
    </nav>
  ...
  <section class="bg-gray-100">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-base leading-6 text-center text-gray-400">
        © {{ new Date().getFullYear() }} REAL Real Estate, Inc. All rights reserved.
      </p>
    </div>
  </section>
</template>
